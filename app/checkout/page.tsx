            ...
            <>
              ...
              >
                ...
                <TabsContent value="monthly" className="mt-4">
                  <div className="p-4 bg-green-50 border-2 border-green-500 rounded-lg shadow-md">
                    <div className="bg-green-600 text-white text-center py-2 px-3 rounded-md mb-3 font-bold text-sm">
                      🎉 DESCONTO ESPECIAL - ECONOMIZE 50%!
                    </div>
                    <div className="flex justify-between mb-2">
                      <span className="font-medium">Plano Mensal</span>
                      <div className="text-right">
                        <div className="text-sm text-gray-400 line-through">De R$ 199,00</div>
                        <span className="font-bold text-green-600 text-2xl">R$ 99,90</span>
                        <div className="text-xs text-gray-600">Por mês</div>
                      </div>
                    </div>
                    <div className="text-sm mb-2 text-green-700 font-semibold">
                      Apenas R$ 99,90 por mês - Sem taxa de adesão!
                    </div>
                ...
                <TabsContent value="annual" className="mt-4">
                  <div className="p-4 bg-yellow-50 border-2 border-yellow-500 rounded-lg shadow-md">
                    <div className="bg-yellow-600 text-white text-center py-2 px-3 rounded-md mb-3 font-bold text-sm">
                      🎉 SUPER DESCONTO - ECONOMIZE 55%!
                    </div>
                    <div className="flex justify-between mb-2">
                      <span className="font-medium">Plano Anual</span>
                      <div className="text-right">
                        <div className="text-sm text-gray-400 line-through">De R$ 1.318,80</div>
                        <span className="font-bold text-yellow-600 text-2xl">R$ 599,90</span>
                        <div className="text-xs text-green-600 font-medium">Pagamento anual</div>
                      </div>
                    </div>
                    <div className="text-sm mb-2 text-gray-600">Apenas R$ 49,99/mês cobrado anualmente</div>
                    <div className="text-sm mb-2 text-yellow-700 font-semibold">
                      Melhor oferta - Economize mais de R$ 700 por ano!
                    </div>
                    <ul className="mt-2 space-y-1 text-sm">
                      <li className="flex items-center">
                        <CheckCircle2 className="h-4 w-4 text-green-500 mr-2" />
